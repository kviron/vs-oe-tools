...
suite('Production task work description links', () => {
    ...
    test('recognizes a contextual task number without linking unrelated short numbers', () => {
        ...
        assert.deepEqual((0, workDescriptionLinks_1.splitWorkDescriptionObjectIds)(value), [
    ...
    test('treats standalone task-sized numbers as tasks for commit comments', () => {
        assert.deepEqual((0, workDescriptionLinks_1.splitWorkDescriptionObjectIds)('Исправлено по 88212 в 2026 году', 'task'), [
            { text: 'Исправлено по ' },
