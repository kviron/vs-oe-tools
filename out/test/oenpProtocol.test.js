...
suite('OENP protocol', () => {
    ...
    test('builds the registered-session packet and reads an authorization challenge', () => {
        ...
        const reconnected = (0, oenpProtocol_1.createInitialPacket)('ffeeddccbbaa99887766554433221100');
        reconnected.writeUInt32LE(42, 8);
        assert.equal((0, oenpProtocol_1.extractClientSessionKey)(Buffer.concat([reconnected, packet])), 'ffeeddccbbaa99887766554433221100');
