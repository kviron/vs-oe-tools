...
const databaseSelectionPath = readOptionalArgument('--database-selection') ?? (0, databaseSelection_1.getActiveDatabaseSelectionPath)();
...
async function bridgeToolResult(body) {
    try {
        await synchronizeDatabaseSelection();
        const navigationInfoPath = explicitNavigationInfoPath ?? (0, navigationInfo_1.getNavigationInfoPath)(workspacePath);
