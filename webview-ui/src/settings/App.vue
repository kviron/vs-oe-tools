...
const postmanApiAction = ref<'start' | 'stop'>();
const postmanApiActionResult = ref<{ success: boolean; message: string }>();
...
window.addEventListener('message', (event: MessageEvent<SettingsHostMessage>) => {
	...
	} else if (message.command === 'postmanApiActionStarted') {
		postmanApiAction.value = message.action;
		postmanApiActionResult.value = undefined;
	} else if (message.command === 'postmanApiActionFinished') {
		postmanApiAction.value = undefined;
		postmanApiActionResult.value = { success: message.success, message: message.message };
	} else {
