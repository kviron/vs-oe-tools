...
import { type PropertyDetailsRow, toMcpClassProperty, propertyValue, isEmptyWriteMember } from '../propertyQueries';
import { normalizeAttributeRecord } from '../attributeQueries';
