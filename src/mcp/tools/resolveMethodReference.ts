...
import { type CallerMethodRow, loadClassChain, resolveQualifierClassIds, type MethodCandidateRow } from '../methodQueries';
import { type MethodResolutionCandidate, resolveMethodCandidates } from '../methodResolution';
import { decodeSourceValue } from '../sourceContent';
import { readAttributeValue } from '../classAttributes';
